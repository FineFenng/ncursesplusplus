#ifndef NCURSESPLUSPLUS_DEMOS_GAME_OF_LIFE_COORDINATES_HPP
#define NCURSESPLUSPLUS_DEMOS_GAME_OF_LIFE_COORDINATES_HPP
#include <algorithm>
#include <vector>
...
#endif  // NCURSESPLUSPLUS_DEMOS_GAME_OF_LIFE_COORDINATES_HPP
