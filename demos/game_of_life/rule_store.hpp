#ifndef NCURSESPLUSPLUS_DEMOS_GAME_OF_LIFE_RULE_STORE_HPP
#define NCURSESPLUSPLUS_DEMOS_GAME_OF_LIFE_RULE_STORE_HPP
#include <map>
#include <string_view>
...
#endif  // NCURSESPLUSPLUS_DEMOS_GAME_OF_LIFE_RULE_STORE_HPP
