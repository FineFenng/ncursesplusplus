#ifndef NCURSESPLUSPLUS_DEMOS_GAME_OF_LIFE_FILETYPE_HPP
#define NCURSESPLUSPLUS_DEMOS_GAME_OF_LIFE_FILETYPE_HPP
#include <string>
...
#endif  // NCURSESPLUSPLUS_DEMOS_GAME_OF_LIFE_FILETYPE_HPP
