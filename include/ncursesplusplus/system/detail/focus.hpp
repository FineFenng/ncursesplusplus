...
class Focus {
   public:
    ...
    static auto focus_widget() -> npp::Widget* { return focus_widget_; }

    /// Sets the focus to \p clicked if it has a Focus_policy::Mouse/Strong.
    static void mouse_press(npp::Widget& clicked);
    ...
    static void direct_set_focus(npp::Widget& w) { focus_widget_ = &w; }

   private:
    static npp::Widget* focus_widget_;
