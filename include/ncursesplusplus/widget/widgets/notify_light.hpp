 ...
 protected:
  auto timer_event() -> bool override {
    ...
    switch (on_block_.symbol) {
      case empty: on_block_.symbol = first;
        break;
      case first: on_block_.symbol = second;
        break;
      case second: on_block_.symbol = third;
        break;
      case third: on_block_.symbol = fourth;
        break;
      case fourth: on_block_.symbol = empty;
        break;
      default: break;
    }
