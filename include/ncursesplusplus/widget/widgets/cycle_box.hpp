...
class Cycle_box : public HLabel {
 ...
 protected:
  auto mouse_press_event(Mouse const &m) -> bool override {
    switch (m.button) {
      case Mouse::Button::Left: this->next();
        break;
      case Mouse::Button::Right: this->previous();
        break;
      default: break;
    }
  ...
  auto mouse_wheel_event(Mouse const &m) -> bool override {
    switch (m.button) {
      case Mouse::Button::ScrollDown: this->next();
        break;
      case Mouse::Button::ScrollUp: this->previous();
        break;
      default: break;
    }
  ...
  auto key_press_event(Key k) -> bool override {
    switch (k) {
      case Key::Arrow_up:
      case Key::k: this->previous();
        break;
      case Key::Arrow_down:
      case Key::j: this->next();
        break;
      default: break;
    }
