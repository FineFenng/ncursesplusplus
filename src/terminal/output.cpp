...
auto trait_to_attr_t(Trait t) -> attr_t {
  ...
  switch (t) {
    case Trait::Bold: result = A_BOLD;
      break;
    case Trait::Underline: result = A_UNDERLINE;
      break;
    case Trait::Standout: result = A_STANDOUT;
      break;
    case Trait::Dim: result = A_DIM;
      break;
    case Trait::Inverse: result = A_REVERSE;
      break;
    case Trait::Invisible: result = A_INVIS;
      break;
    case Trait::Blink: result = A_BLINK;
      break;
    case Trait::Italic: result = A_ITALIC;
      break;
  }
  return result;
}
